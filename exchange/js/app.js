...
function get_percentage() {
  if ($(".my_coin_name :selected").text() == "Select coin name") {
    ...
    $.post("/exchange/get_token_networks/", {
      ...
      if (data["transfer_fee_naira"] > 0) {
        document.getElementById(
          "buy_warning"
        ).innerText = `Note : Buying ${data["token_name"]} attracts a ₦${data["transfer_fee_naira"]} charge.`;
      } else if (data["transfer_fee_dollar"] > 0) {
        document.getElementById(
          "buy_warning"
        ).innerText = `Note : Buying ${data["token_name"]} attracts a $${data["transfer_fee_dollar"]} charge.`;
      } else {
...
$(".canceled_txn").click(function () {
  ...
  $.post("/exchange/get_order_info/", {
    ...
    var html_data = ``;
    var html_data_2 = `<span onclick="copy_order_id('${data["order_id"]}')"><p style="text-align: center;font-size: 14px;margin: -30px 0 40px;font-family: Poppins;font-style: normal;font-weight: normal;line-height: 135%;color: #F08B35;">Copy Order ID</p></span>`;
    var report_trade = `<a href="https://t.me/VeloxSupportBot?start=${data["order_id"]}"><span><p style="text-align: center;font-size: 14px;margin: -30px 0 40px;font-family: Poppins;font-style: normal;font-weight: normal;line-height: 135%;color: #EB5757;">Report Trade</p></span></a>`;
...
$(".succ_txn").click(function () {
  ...
  $.post("/exchange/get_order_info/", {
    ...
    var html_data = ``;
    var html_data_2 = `<span onclick="copy_order_id('${data["order_id"]}')"><p style="text-align: center;font-size: 14px;margin: -30px 0 40px;font-family: Poppins;font-style: normal;font-weight: normal;line-height: 135%;color: #F08B35;">Copy Order ID</p></span>`;
    //var report_trade = `<span onclick="report_txn('${data['order_id']}')"><p style="text-align: center;font-size: 14px;margin: -30px 0 40px;font-family: Poppins;font-style: normal;font-weight: normal;line-height: 135%;color: #EB5757;">Report Trade</p></span>`
